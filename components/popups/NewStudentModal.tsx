            ...
            <KeyboardAvoidingView behavior={'padding'} style={styles.kav}>
                <View style={styles.mainForm} >
                    <View style={styles.formGroup}>
                        <TextInput style={styles.textInput} onChangeText={(value) => setName(value)} placeholder={'Name'} />
                    </View>
                    <View style={styles.formGroup}>
                        <TextInput style={styles.textInput} onChangeText={(value) => setSurname(value)} placeholder={'Surname'} />
                    </View>
                    <View style={styles.formGroup}>
                        <TextInput style={styles.textInput} onChangeText={(value) => setEmail(value)} placeholder={'Email'} />
                    </View>
                    <View style={styles.formGroup}>
                        <TextInput style={styles.textInput} onChangeText={(value) => setCell(value)} placeholder={'Cell'} />
                    </View>
                    <View style={styles.formGroup}>
                        <TextInput style={styles.textInput} keyboardType={"numeric"} onChangeText={(value) => handleFeeInput(value)} placeholder={'Hourly Fee'} />
                    </View>
